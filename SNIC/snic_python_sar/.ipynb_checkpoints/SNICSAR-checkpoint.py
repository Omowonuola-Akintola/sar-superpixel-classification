...
def segment(imgname,numsuperpixels,compactness,doRGBtoLAB = False):
	#--------------------------------------------------------------
...
def snicdemo():
	...
	numsuperpixels = 500
	compactness = 20.0
	doRGBtoLAB = False #True # only works if it is a three channel image
	# imgname = "/Users/achanta/Pictures/classics/lena.png"
	with rasterio.open("../../Data/Bangladeshtest.tif") as src:
		imgname = src.read(1)

	labels,numlabels = segment(imgname,numsuperpixels,compactness,doRGBtoLAB = False)
	#--------------------------------------------------------------
